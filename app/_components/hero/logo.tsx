...
export default function LogoHero({ className = "" }) {
  ...
  let gradientMove = useMotionTemplate`translate(${mouseXSpring} ${mouseYSpring}) rotate(112.237) scale(350.073 350.056)`;

  function handleMouseMove({ currentTarget, clientX, clientY }: MouseEvent) {
    if (!currentTarget || !ref.current) return;

    let { left, top, right } = ref.current.getBoundingClientRect();
  ...
  return (
    <div
      ...
      className="relative -bottom-6 top-0 flex h-full w-full items-center justify-center pb-12 lg:px-24 lg:pt-24"
    >
      <motion.svg
        ref={ref}
